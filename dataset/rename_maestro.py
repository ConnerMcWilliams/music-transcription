...
if __name__ == '__main__':
    ...
    parser.add_argument('-d_i', help='MAESTRO original corpus directory (input)', default='/dataset/MAESTRO')
    parser.add_argument('-d_o', help='MAESTRO renamed corpus directory (output)', default='/dataset/MAESTRO')
